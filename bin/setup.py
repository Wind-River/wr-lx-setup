...
class Setup():
    ...
    def main(self, orig_args):
        ...
        logger.info('Setting distro to "%s"' % (self.distros))
        logger.info('Setting machine to "%s"' % (self.machines))
        logger.info('Setting layers to "%s"' % (self.layers))
        logger.info('Setting recipes to "%s"' % (self.recipes))
