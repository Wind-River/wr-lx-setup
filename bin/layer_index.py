...
class Layer_Index():
    ...
    def find_layer(self, lindex, id=None, name=None, layerBranch=None, layerBranchId=None, distro=None, machine=None, recipe=None):
        result = []
    ...
    def getLayerBranch(self, lindex, branchid, layerBranchId=None, collection=None, name=None, distro=None, machine=None, recipe=None, layerItem=None):
        result = []
        if layerBranchId:
            for lb in lindex['layerBranches']:
